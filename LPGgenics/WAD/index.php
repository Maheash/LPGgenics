      ...
      <!-- loader END -->
                ...
                <div class="bg-white form-container sign-up-container">
                   <div class="sign-in-page-data">
                      <div class="sign-in-from w-100 m-auto">
                          ...
                          <p class="text-center text-dark">Enter your email address and password to Sign up.</p>
                          <form class="mt-4" action="signup.php" method="post">
                              <div class="form-group">
                                  <label for="exampleInputEmail1">Your Full Name</label>
                                  <input type="text" name="full" class="form-control mb-0" id="exampleInputEmail1" placeholder="Your Full Name">
                              </div>
                              <div class="form-group">
                                  <label for="exampleInputEmail2">Email address</label>
                                  <input type="text" name="email" class="form-control mb-0" id="exampleInputEmail2" placeholder="Enter email">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="sign-info">
                                  <button type="submit" name="signup" class="btn btn-primary mb-2">Sign Up</button>
       ...
       <div class="iq-colorbox color-fix">
           ...
           <div class="clearfix color-picker">
               ...
               <p>Choose Theme For Your Better Clarity </p>
